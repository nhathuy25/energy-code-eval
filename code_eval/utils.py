    ...
    **gen_kwargs
    ...
    for step, batch in tqdm(
        ...
        try:
            ...
            energy_key = f"batch_{step}_mns{model.llm_engine.vllm_config.scheduler_config.max_num_seqs}_max-toks{gen_kwargs["max_tokens"]}_n{dataloader.dataset.n_copies}"
            if energy_monitor:
