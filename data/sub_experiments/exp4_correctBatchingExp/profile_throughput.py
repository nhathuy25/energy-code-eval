...
# Create test prompt for abundant last batch
def create_test_prompts(
    ...
    nb_last_questions = len(dataset) % mns
...
def main(args: argparse.Namespace):
    ...
    if generated_outputs is not None:
        ...
        df.to_csv(os.path.join(os.path.curdir, 'data/generated_outputs_info.csv'), index=False)
